...
//!     3=Indexed8, 4=Indexed4, 5=Indexed1, 6/7 wrap back to Rgba/Rgb24.
...
/// Map the format selector byte onto a [`BmpPixelFormat`]. Two unused
/// codes (6, 7) wrap back to the direct-colour formats to keep the
